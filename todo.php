<head>
  ...
  <body>
    ...
    <main>
        <style>@import url("https://fonts.googleapis.com/css?family=Gochi+Hand");
            main {
            ...
            .toDoList a:hover {
              text-decoration: line-through wavy #E5446D 2px;
            }
            ...
            .toDoList2 a:hover
            {
              text-decoration: line-through wavy rgba(269,68,109 0.12);
            }
            </style>
