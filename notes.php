      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a href="#" class="nav-link">
            ...
            <span class="link-text">Αφιερώσεις</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a href="todo.php" class="nav-link">
            ...
            <span class="link-text">Η λίστα μας</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a href="#" class="nav-link">
            ...
            <span class="link-text">touvlaki</span>
          </a>
        </li>
        ...
        <li class="nav-item" id="themeButton">
          <a href="#" class="nav-link">
            ...
            <span class="link-text">Made by Ντρούλης</span>
          </a>
        </li>
      </ul>
    </nav>
...
<div class="love-notes-container">
    ...
    <?php
      ...
      if (isset($list))
      {
        ...
        {
          $originalString =strip_tags($item['body']) ;
          
          $yourTextVariable = $originalString; // Replace this with your actual text variable

          // Explode the string into an array of words
          $words = explode(' ', $yourTextVariable);

        // Take the first words
        $preview = implode(' ', array_slice($words, 0, 7));
        echo '<a class="love_note" href="post.php?show_post='.$item['id'].'"><div class="love-note">
         <h2 class="love-note-title">'.$item['title'].'</h2>
         <p class="love-note-preview">'.$preview.'...</p>
     </div></a>';
        }
    }
    ?>
